...
[![Build Status](https://travis-ci.org/ghusta/docker-postgres-world-db.svg?branch=alpine)](https://travis-ci.org/ghusta/docker-postgres-world-db)
...
`docker run -d -pxxxx:5432 ghusta/postgres-world-db:2.4-alpine`
